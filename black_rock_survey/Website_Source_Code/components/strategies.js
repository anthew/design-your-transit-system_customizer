...
const Strategies = () => {
  ...
  const postData = async () => {
    ...
    const form = { 
      language: locale, 
      ...selectedStrategies,
      userComment, // Add the user comment to the form data
    }
    ...
    <div>
      ...
      <form onSubmit={submit}>
        ...
        <div className="my-5 mx-4 md:mx-0 flex flex-row-reverse">
          ...
          />
          <button
            className="btn-bottom btn-reset"
            onClick={reset}
            disabled={submitting}
          >
      ...
      >
        ...
        <div className="pt-4 pb-5 px-3">
          ...
          {modalSettings.title === settings.text[locale].modalSubmitTitle && settings.commentBoxEnabled && (
            <textarea
              maxLength={settings.commentBoxMaxCharacters.toString()}
